    ...
    return (
        <Container fluid>
            ...
            <Row className="justify-content-center">
                <Col xs="auto">
                    <Image src="src\WorldPeas Imgs\jonathan-kemper-1HHrdIoLFpU-unsplash 1.png" />
                </Col>
                <Col xs="auto" className="ms-4">
                    <Figure className="mt-5 pt-5">
                        <Figure.Image src="src/WorldPeas Imgs/Stocksy_txp226f62b2aNe300_Medium_4582193 1.png"/>
                        <Figure.Caption>
